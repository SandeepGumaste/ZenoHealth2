      ...
      <div className="container">
        <div className="row g-4 g-lg-5 ">
          <div className="col-lg-6 position-relative mb-4 mb-md-0">
            <h1 className={`${styles.heading} mb-4 mt-md-5`}>
              Find the top
          ...
          <div className="col-lg-6 position-relative">
            ...
            <div
              className={`${styles.imageCircleContainer} gap-5 align-items-center position-absolute top-0 d-none d-md-flex mt-4 flex-column`}
            >
              <ImageCircle
